...
4. By default, the app deploy on port 3000. To use the app you can:
    ...
    - **SwaggerUI** Go to [localhost:3000/api-docs](http://localhost:3000/api-docs/) to see swagger playground or [Swagger deployed](https://readease-server-xd7z.onrender.com/api-docs/).
    - **Deploy** Use the already deployed [API](https://readease-server-xd7z.onrender.com) and use the different API endpoints.
