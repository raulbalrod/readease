...
const HeaderDiscoveryPage: React.FC = () => {
    ...
    <header className="flex items-center justify-between bg-primary w-screen py-6 px-10 z-50">
      <nav className="hidden md:flex items-center gap-10">
        ...
        <ul className="flex gap-4 font-medium">
          ...
          <li className="text-lg uppercase font-medium text-secondary hover:text-secondary/90">
      ...
      <section className="flex items-center gap-6">
        <a href="/books/discovery" className="block md:hidden">
          <i className="bx bx-search-alt bx-sm text-secondary hover:text-secondary/80 cursor-pointer block md:hidden"></i>
        </a>
        <i
...
export default HeaderDiscoveryPage
